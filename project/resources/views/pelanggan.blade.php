      ...
      <div class="rs-gallery gallery-style1 pt-120 pb-120 md-pt-80 md-pb-80">
        <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
              <p class="text-center">Banyak perusahaan besar telah menggunakan produk dari 
                kami sebagai komponen dari produknya, selanjutnya giliran anda.</p>
            </div>
          </div>
          <div class="row justify-content-center">
            <ul id="customers_ku" class="row justify-content-center thumbnails"></ul>
            <div id="loader_customer" class="spinner-border text-primary mt-5" role="status">
      ...
      async function load_data() {
        ...
        try {
            ...
            $.each(data.data, function(key, val) {
              ...
              contents.push('<li class="col-md-3 col-sm-12" title="' + val.nama + '">' +
                          '<img src="' + new_images + '" class="customer_logo" alt="Customer">' +
                        '</li>');
            });

            $("#loader_customer").hide();
            $("#customers_ku").html(contents);
        } catch (error) {
          Swal.fire(
            'Oops...',
